...
call_user_func(function () {
    ...
    $GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['modul_galeriekarussell'] = 'tx_modul_galeriekarussell';

    $GLOBALS['TCA']['tt_content']['columns']['CType']['config']['items'][] = [
        'Galerie Karussell',
        'modul_galeriekarussell',
    ...
    $tempTypes = [
        'modul_galeriekarussell' => [
            ...
            tx_modul_bild,tx_modul_backgroundcolor,--div--;
