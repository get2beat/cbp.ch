...
call_user_func(function () {
    ...
    $GLOBALS['TCA']['tt_content']['ctrl']['typeicon_classes']['modul_bildtext'] = 'tx_modul_bildtext';
    ...
    $tempTypes = [
        ...
        assets, tx_modul_bildfilter, --palette--;;paletteBild,bodytext, tx_modul_backgroundcolor,--palette--;;paletteButton,--div--;
